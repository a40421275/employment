package com.shera.framework.employment.employment.modules.system.entity;
...
public class SystemConfig extends BaseEntity {
    ...
    private String valueType; // 配置值类型
    
    @Column(name = "editable")
    private Boolean editable = true; // 是否可编辑
    
    @Column(name = "system_config")
    private Boolean systemConfig = false; // 是否为系统配置
    ...
    private String options; // 选项值（JSON格式）
